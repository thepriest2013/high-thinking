---
title: '[Example] A Personal Development Post'
...
Replace this file's content with a real post, or delete it, then set `draft: false` (or remove the field — it defaults to `false`).
